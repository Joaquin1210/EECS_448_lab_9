...
echo "<table border=\"3\">";
	...
	for ($b=1; $b<=$rows; $b++)
            	...
            	for($c=1; $c<=$cols; $c++)
		{
			...
			if ($c==1 && $b==2)
			{
				echo('<td><center>'.'Basketball Jersey'.'</td>');
			}
			if ($c==1 && $b==3)
			{
				echo('<td><center>'.'Final Four Hat'.'</td>');
			}
			if ($c==1 && $b==4)
			{
				echo('<td><center>'.'Championship T-shirt'.'</td>');
			}
			if ($c==1 && $b==5)
			{
			...
			if ($c==2 && $b==2)
			{
				echo('<td><center>'.$jerseys.'</td>');
			}
			if ($c==2 && $b==3)
			{
				echo('<td><center>'.$hats.'</td>');
			}	
			if ($c==2 && $b==4)
			{
				echo('<td><center>'.$shirts.'</td>');
			}
			if ($c==2 && $b==5)
			{
			...
			if ($c==3 && $b==2)
			{
				echo('<td><center>'.'$80.00'.'</td>');
			}
			if ($c==3 && $b==3)
			{
				echo('<td><center>'.'$10.00'.'</td>');
			}	
			if ($c==3 && $b==4)
			{
				echo('<td><center>'.'$25.00'.'</td>');
			}
